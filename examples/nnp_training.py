...
def main_training(get_network, optimizer_for_network, do_transform_after=True):
    ...
    energy_shifter_before = torchani.utils.EnergyShifter(None, fit_intercept=True)
    energy_shifter = torchani.utils.EnergyShifter(None, fit_intercept=True)
    ...
    AdamW, SGD = optimizer_for_network(C_network, H_network, N_network, O_network)
...
def get_optimizers_for_BN_network(C_network, H_network, N_network, O_network):
    AdamW = torchani.optim.AdamW([
        # H networks
        {'params': [H_network[1].weight]},
        {'params': [H_network[4].weight], 'weight_decay': 0.00001},
        {'params': [H_network[7].weight], 'weight_decay': 0.000001},
        {'params': [H_network[10].weight]},
        # C networks
        {'params': [C_network[1].weight]},
        {'params': [C_network[4].weight], 'weight_decay': 0.00001},
        {'params': [C_network[7].weight], 'weight_decay': 0.000001},
        {'params': [C_network[10].weight]},
        # N networks
        {'params': [N_network[1].weight]},
        {'params': [N_network[4].weight], 'weight_decay': 0.00001},
        {'params': [N_network[7].weight], 'weight_decay': 0.000001},
        {'params': [N_network[10].weight]},
        # O networks
        {'params': [O_network[1].weight]},
        {'params': [O_network[4].weight], 'weight_decay': 0.00001},
        {'params': [O_network[7].weight], 'weight_decay': 0.000001},
        {'params': [O_network[10].weight]},
    ])

    SGD = torch.optim.SGD([
        # H networks
        {'params': [H_network[10].bias]},
        # C networks
        {'params': [C_network[10].bias]},
        # N networks
        {'params': [N_network[10].bias]},
        # O networks
        {'params': [O_network[10].bias]},
    ], lr=1e-3)
    return AdamW, SGD


def get_optimizers_for_BN_notAEV_network(C_network, H_network, N_network, O_network):
    AdamW = torchani.optim.AdamW([
        # H networks
        {'params': [H_network[0].weight]},
        {'params': [H_network[3].weight], 'weight_decay': 0.00001},
        {'params': [H_network[6].weight], 'weight_decay': 0.000001},
        {'params': [H_network[9].weight]},
        # C networks
        {'params': [C_network[0].weight]},
        {'params': [C_network[3].weight], 'weight_decay': 0.00001},
        {'params': [C_network[6].weight], 'weight_decay': 0.000001},
        {'params': [C_network[9].weight]},
        # N networks
        {'params': [N_network[0].weight]},
        {'params': [N_network[3].weight], 'weight_decay': 0.00001},
        {'params': [N_network[6].weight], 'weight_decay': 0.000001},
        {'params': [N_network[9].weight]},
        # O networks
        {'params': [O_network[0].weight]},
        {'params': [O_network[3].weight], 'weight_decay': 0.00001},
        {'params': [O_network[6].weight], 'weight_decay': 0.000001},
        {'params': [O_network[9].weight]},
    ])

    SGD = torch.optim.SGD([
        # H networks
        {'params': [H_network[9].bias]},
        # C networks
        {'params': [C_network[9].bias]},
        # N networks
        {'params': [N_network[9].bias]},
        # O networks
        {'params': [O_network[9].bias]},
    ], lr=1e-3)
    return AdamW, SGD
